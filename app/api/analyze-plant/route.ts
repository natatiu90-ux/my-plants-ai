...
const schema = {
  ...
  schema: {
    ...
    properties: {
      ...
      primaryAction: localizedNullableStringSchema,
      actionTimeframe: localizedNullableStringSchema,
      statusReason: localizedNullableStringSchema,
    ...
    const inputContent = [
      {
        ...
        text: [
          ...
          "Do not sound like ChatGPT. Avoid generic assistant language and robotic phrases such as 'I updated recommendations because', 'recommendations were reduced to', 'no urgent measures are needed', 'context was updated', 'AI thinks', 'Most likely', 'It seems', 'Based on the information', or 'It is recommended'. Prefer practical plant-centered wording.",
          ...
          "Never state uncertain conclusions as facts. Distinguish clearly between what is visible, what is possible, and what remains unknown.",
          "Never describe invisible information. Do not mention hidden roots, internal tissue, watering history, root condition, pests, fungus, disease, or drainage unless there is actual visual evidence or explicit saved user context.",
          "Good news first: when nothing serious is happening, start with reassurance such as 'The plant looks stable' or 'Nothing currently suggests a serious problem', then give the next practical thing to check.",
          "Old damage, cosmetic marks, natural aging, and recent repotting are not emergencies by themselves. Separate historic damage, active deterioration, and current risk.",
          "Prioritize the current state over old events. Mention repotting, moving, or past care only when it still changes what the owner should do now.",
          "Do not let every case collapse into watering advice. Watering advice should appear only when soil, symptoms, species needs, or saved care history make it relevant.",
          "Avoid repeating identical advice across sections. If one action already says what to check, choose a different useful observation target or omit repetition.",
          "Every action must tell the owner exactly what to do. Bad: 'Observe.' Better: 'Over the next two weeks, check whether new growth appears without fresh damage.'",
          ...
          "Also return urgency, primaryAction, actionTimeframe, and statusReason. These fields must align with plantStatus.",
          "Use healthy as the default when the plant's visible growth looks healthy, no meaningful stress is visible, and no care action is needed. Healthy plants should frequently be healthy.",
          ...
          "Do not assign action_needed unless primaryAction is a concrete intervention and actionTimeframe means now, today, or within 24 hours.",
          "Do not assign needs_attention unless primaryAction is a concrete check or adjustment and actionTimeframe means soon or within the next few days.",
          "Invalid combinations that must be downgraded before returning: action_needed with watch new growth, action_needed with no urgent action, action_needed with wait for soil to dry, needs_attention without any check or adjustment, healthy with immediate intervention.",
          "If advice says nothing urgent, plantStatus cannot be action_needed. Use healthy, adapting, or watch depending on the plant's current state.",
          "When plantStatus is needs_attention or action_needed, summary and careRightNow must clearly answer what to do and how soon.",
          ...
          "When old damaged tissue, dry edges, scorch, corking, or cosmetic marks are visible, clearly distinguish old irreversible tissue from new active symptoms. Explain that old damaged tissue will not recover when relevant.",
          "When recommending observation, be concrete: say what improvement looks like, what deterioration looks like, and which species-appropriate signs to check.",
          "The main explanation must connect visible observations to species biology, recent plant history, and current context. Do not jump from observation directly to action.",
          "The main explanation must explain why it fits better than the main plausible alternatives when confidence is limited. Use cautious wording instead of certainty if drought stress, mechanical damage, repotting stress, and light stress are all possible.",
          ...
          "If environmentContext includes weather, use it only as supporting context for soil drying risk, heat stress risk, and soil-check timing. Hot weather must not by itself create a watering recommendation; first ask or use stored soil moisture. In heat, prefer checking soil sooner, especially near windows, bright light, direct sun, balconies, or warm rooms. Reduce this concern in cool rooms, shade, or air-conditioned rooms.",
          ...
          "For Haworthia and similar leaf-forming succulents, wet soil and abrupt direct sun are usually more important risks than short-term dry soil; old damaged tissue may remain marked while new growth shows recovery.",
          ...
          "Ask clarification questions only when the answer can significantly improve confidence or change care, urgency, next action, or next check timing. Do not ask curiosity questions.",
          ...
          "Pay attention to photo types: overview for overall form/light response, leaf close-up for foliage plants, close-ups of the body/ribs/stems for cactus and succulents, pot/soil for soil-zone clues, roots only for root observations, problem for visible damage.",
          ...
          isInitialAddFast
            ...
            : isPlantCheckin
              ? "Plant check-in rule: this request is not a new primary plant analysis. Photo sources marked gallery/camera/local are the current check-in photos; photo sources marked comparison_baseline are previous photos. Compare current photos with baseline photos, previousAnalysis, and recent care events. Answer the main question: what changed since the previous check? Focus on concrete change: new growth, turgor, color, leaf drop, stem/cut condition, soil surface, or visible worsening. Do not invent improvement or deterioration without visual evidence. Use photoComparison heavily: fill observationsImproved, observationsWorsened, observationsUnchanged, reliableComparison, and a short plant-centered message. If previousAnalysis shows recovery, needs_attention, pruning, repotting, or unresolved concerns, do not jump to healthy/nothing-to-do from one mildly positive photo. Prefer adapting/watch/check_soon language such as recovery continues, stable, or improved but still monitor unless the photos clearly show sustained recovery and no active follow-up remains. Only update recommendations if the new evidence genuinely changes care. If angles are too different, set reliableComparison false and say comparison is unclear."
