  ...
  return (
    <div className="min-w-0 rounded-[24px] bg-white/70 p-4">
      ...
      <div className="mt-4 flex flex-wrap gap-2.5">
        ...
        {onAddPhoto ? (
          <button type="button" onClick={onAddPhoto} className="min-h-11 rounded-[18px] bg-white/85 px-4 text-sm font-extrabold text-[#5f594f]">
...
export function PlantAnalysisSection({
    ...
    return (
      <section className="mt-5 min-w-0 rounded-[30px] bg-[#fffaf3] p-5 shadow-soft">
        ...
        {hasPendingBaselineQuestions && !conversationalState.question ? (
          <p className="mx-1 mt-3 rounded-[20px] bg-[#eef5e8] p-4 text-[15px] font-bold leading-6 text-[#4f6946]">{t("plantAnalysis.pendingBaselineQuestions")}</p>
        ) : null}
        ...
        <div className="mt-4 grid gap-3">
          {conversationalState.question ? (
            <div className="min-w-0 rounded-[28px] bg-[#eef5e8] p-4">
              ...
              {savingAnswerKey ? <p className="mt-3 text-sm font-bold text-[#8a8378]">{t("plantAnalysis.updatingRecommendations")}</p> : null}
              {answerError ? <p className="mt-3 rounded-[18px] bg-[#fdeaf0] p-3 text-sm font-bold leading-5 text-[#9b2c3e]">{answerError}</p> : null}
            </div>
          ) : completedFact ? (
            <div className="min-w-0 rounded-[28px] bg-[#eef5e8] p-4">
            ...
            <div className="min-w-0 rounded-[28px] bg-[#eef5e8] p-4">
              ...
              <p className="mt-2 text-[15px] font-extrabold leading-6 text-[#355f3d] [overflow-wrap:anywhere]">
          ...
          {conversationalState.caution ? (
            <div className="min-w-0 rounded-[24px] bg-[#fff8e8] p-4">
              <p className="text-[15px] font-bold leading-6 text-[#8a6230] [overflow-wrap:anywhere]">{conversationalState.caution}</p>
            </div>
          ) : null}
          ...
          <details className="min-w-0 rounded-[24px] bg-white/55 p-4">
  ...
  return (
    <section className="mt-5 min-w-0 rounded-[30px] bg-[#fffaf3] p-5 shadow-soft">
      ...
      <div className="mt-4 grid gap-3">
        <div className="min-w-0 rounded-[28px] bg-[#eef5e8] p-4">
          <p className="text-[15px] font-bold leading-6 text-[#355f3d] [overflow-wrap:anywhere]">{view.keyTakeaway}</p>
        </div>
        ...
        {view.density === "serious" && view.lowConfidenceHypotheses.length ? (
          <div className="min-w-0 rounded-[24px] bg-white/55 p-4">
            <button
              type="button"
